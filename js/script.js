...
Затем распределяет учеников по 3 человека в 3 группы по алфавитному порядку. Эти группы должны быть массивами. 
...
//________________Упражнения с собеседований на понимание основ________________

// •	Какое будет выведено значение: let x = 5; alert( x++ ); ?
let j=5;
alert(x++); //Ответ: выдаст окно с 6
...
let y =1;
let x=y=2;
console.log(x); //Ответ: выдаст окно с 2 
// •	Чему равна сумма [ ] + 1 + 2?

console.log([ ]+1+2); // Ответ: выдаст окно с 12
// •	Что выведет этот код: alert( "1"[0] )?

console.log("1"[0]); // Ответ: выдаст окно с 1
// •	Чему равно 2 && 1 && null && 0 && undefined ?

console.log(2 && 1 && null && 0 && undefined); // Ответ: null
// •	Есть ли разница между выражениями? !!( a && b ) и (a && b)?
// Ответ: первое выражение выйдет как булеан операция а второе просто если и то и то выполняется.
...
if(f==d)
{
   ...
   console.log("Unequal");
}// как выдает консоль они не равны
...
которая будет печатать числа от 0 до 1000, кратные трём и не кратные пяти,
